...
DOCSET_ARCHIVE_BASENAME = $(DOCSET_BASENAME_NO_EXT).tgz
DOCSET_ARCHIVE_PATH     = $(GENERATED_PATH)/$(DOCSET_ARCHIVE_BASENAME)
...
$(DOCSET_ARCHIVE_PATH): docset
	cd $(GENERATED_PATH) && tar --exclude=.DS_Store -czf $(DOCSET_ARCHIVE_BASENAME) $(DOCSET_BASENAME)
